...
options.register ('globaltag',
                  ...
                  VarParsing.multiplicity.singleton,
                  VarParsing.varType.string,
                  "Global Tag to use. Default: START71_V11::All")
...
switchJetCollection(process,
     ...
     #doJTA        = True,
     #doBTagging   = True,
     jetCorrections = ('AK5PF', jec,'Type-2'),
...
process.electronVariables = cms.EDProducer('ElectronsUserEmbedder',
	...
	vertexTag = cms.InputTag("offlinePrimaryVerticesWithBS"),
	doMVAPOG = cms.untracked.bool(True),
	infileTrig0 = cms.FileInPath('AnalysisSpace/PattupleMaker/data/Electrons_BDTG_TrigV0_Cat1.weights.xml'),
    	infileTrig1 = cms.FileInPath('AnalysisSpace/PattupleMaker/data/Electrons_BDTG_TrigV0_Cat2.weights.xml'),
    	infileTrig2 = cms.FileInPath('AnalysisSpace/PattupleMaker/data/Electrons_BDTG_TrigV0_Cat3.weights.xml'),
    	infileTrig3 = cms.FileInPath('AnalysisSpace/PattupleMaker/data/Electrons_BDTG_TrigV0_Cat4.weights.xml'),
    	infileTrig4 = cms.FileInPath('AnalysisSpace/PattupleMaker/data/Electrons_BDTG_TrigV0_Cat5.weights.xml'),
    	infileTrig5 = cms.FileInPath('AnalysisSpace/PattupleMaker/data/Electrons_BDTG_TrigV0_Cat6.weights.xml'),
    	infileNonTrig0 = cms.FileInPath('AnalysisSpace/PattupleMaker/data/Electrons_BDTG_NonTrigV0_Cat1.weights.xml'),
    	infileNonTrig1 = cms.FileInPath('AnalysisSpace/PattupleMaker/data/Electrons_BDTG_NonTrigV0_Cat2.weights.xml'),
    	infileNonTrig2 = cms.FileInPath('AnalysisSpace/PattupleMaker/data/Electrons_BDTG_NonTrigV0_Cat3.weights.xml'),
    	infileNonTrig3 = cms.FileInPath('AnalysisSpace/PattupleMaker/data/Electrons_BDTG_NonTrigV0_Cat4.weights.xml'),
    	infileNonTrig4 = cms.FileInPath('AnalysisSpace/PattupleMaker/data/Electrons_BDTG_NonTrigV0_Cat5.weights.xml'),
    	infileNonTrig5 = cms.FileInPath('AnalysisSpace/PattupleMaker/data/Electrons_BDTG_NonTrigV0_Cat6.weights.xml'),
)
...
#
#from EgammaAnalysis.ElectronTools.electronIdMVAProducer_cfi import mvaTrigV0,mvaNonTrigV0
process.load('EgammaAnalysis.ElectronTools.electronIdMVAProducer_cfi')

process.mvaTrigV0.electronTag = cms.InputTag('gedGsfElectrons')
process.mvaTrigV0.mvaWeightFile = cms.vstring(
        'AnalysisSpace/PattupleMaker/data/Electrons_BDTG_TrigV0_Cat1.weights.xml',
        'AnalysisSpace/PattupleMaker/data/Electrons_BDTG_TrigV0_Cat2.weights.xml',
        'AnalysisSpace/PattupleMaker/data/Electrons_BDTG_TrigV0_Cat3.weights.xml',
        'AnalysisSpace/PattupleMaker/data/Electrons_BDTG_TrigV0_Cat4.weights.xml',
        'AnalysisSpace/PattupleMaker/data/Electrons_BDTG_TrigV0_Cat5.weights.xml',
        'AnalysisSpace/PattupleMaker/data/Electrons_BDTG_TrigV0_Cat6.weights.xml'
)
process.mvaNonTrigV0.electronTag = cms.InputTag('gedGsfElectrons')
process.mvaNonTrigV0.mvaWeightFile = cms.vstring(
        'AnalysisSpace/PattupleMaker/data/Electrons_BDTG_NonTrigV0_Cat1.weights.xml',
        'AnalysisSpace/PattupleMaker/data/Electrons_BDTG_NonTrigV0_Cat2.weights.xml',
        'AnalysisSpace/PattupleMaker/data/Electrons_BDTG_NonTrigV0_Cat3.weights.xml',
        'AnalysisSpace/PattupleMaker/data/Electrons_BDTG_NonTrigV0_Cat4.weights.xml',
        'AnalysisSpace/PattupleMaker/data/Electrons_BDTG_NonTrigV0_Cat5.weights.xml',
        'AnalysisSpace/PattupleMaker/data/Electrons_BDTG_NonTrigV0_Cat6.weights.xml'
)
...
process.goodOfflinePrimaryVerticesPFlow = process.goodOfflinePrimaryVertices.clone()
...
#process.pileupJetIdCalculator.residualsTxt = cms.FileInPath("AnalysisSpace/PattupleMaker/data/dummy.txt")
#process.pileupJetIdEvaluator.residualsTxt = cms.FileInPath("AnalysisSpace/PattupleMaker/data/dummy.txt")
...
process.p = cms.Path(
	#process.counter *
        process.goodOfflinePrimaryVerticesPFlow* 
        process.PFBRECO *
...
#	'root://xrootd.unl.edu//store/mc/Summer12_DR53X/WH_ZH_TTH_HToTauTau_M-125_8TeV-pythia6-tauola/AODSIM/PU_S10_START53_V7A-v1/0000/F6D5A425-64EF-E111-9AA5-001A645C8E36.root'
#   ]                                           ##  (e.g. 'file:AOD.root')
#                                               ##
