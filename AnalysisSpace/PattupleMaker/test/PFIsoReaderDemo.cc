...
// inputTagIsoDepElectrons_ = iConfig.getParameter< std::vector<edm::InputTag> >("IsoDepElectron");
  tokensIsoDepElectrons_ = edm::vector_transform(iConfig.getParameter< std::vector<edm::InputTag> >("IsoDepElectron"), [this](edm::InputTag 
const & tag){return consumes<edm::ValueMap<reco::IsoDeposit> >(tag);});
// inputTagIsoDepPhotons_ = iConfig.getParameter< std::vector<edm::InputTag> >("IsoDepPhoton");
  tokensIsoDepPhotons_ = edm::vector_transform(iConfig.getParameter< std::vector<edm::InputTag> >("IsoDepPhoton"), [this](edm::InputTag const 
& tag){return consumes<edm::ValueMap<reco::IsoDeposit> >(tag);});
...
// inputTagIsoValElectronsPFId_ = iConfig.getParameter< std::vector<edm::InputTag> >("IsoValElectronPF");
  tokensIsoValElectronsPFId_ = edm::vector_transform(iConfig.getParameter< std::vector<edm::InputTag> >("IsoValElectronPF"), 
...
// inputTagIsoValPhotonsPFId_ = iConfig.getParameter< std::vector<edm::InputTag> >("IsoValPhoton");
  tokensIsoValPhotonsPFId_ = edm::vector_transform(iConfig.getParameter< std::vector<edm::InputTag> >("IsoValPhoton"), [this](edm::InputTag 
const & tag){return consumes<edm::ValueMap<double> >(tag);});
